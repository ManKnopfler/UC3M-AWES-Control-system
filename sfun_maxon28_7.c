#define S_FUNCTION_NAME  sfun_maxon28_7
...
//     VCS_SetObject(mHandle,NodeID,24728,0, -3, 5);
    
//     if (!VCS_FindHome(mHandle, NodeID, HM_CURRENT_THRESHOLD_POSITIVE_SPEED, &ErrCode)) {
//          mexPrintf("Error Enabling Node, ErrCode is %i\n", (int) ErrCode);
//         ssSetErrorStatus(S, "Error Enabling Device");
//         /* release lock */
//         LeaveLock();
